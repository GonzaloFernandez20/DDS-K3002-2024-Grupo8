...
public class RepositorioOfertas {
    ...
    private static List<OfertaDeUnProducto> ofertas = List.of(
            ...
            new OfertaDeUnProducto(new Colaborador(new PersonaJuridica("Gastronomos Argentinos", TipoOrganizacion.ONG, "GASTRONOMIA", new Direccion("Perú", "50")), List.of(new Mail("gastronomosargentinos@gmail.com"))), "Lámpara Blanca", 250, "/img/dar.png", Rubro.ARTICULOS_PARA_EL_HOGAR, new Producto("Lámpara blanca", 50))
    );
