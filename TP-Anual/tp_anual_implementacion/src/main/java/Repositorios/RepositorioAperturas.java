...
public class RepositorioAperturas {
    ...
    public Integer cantidadDeDepositosDeHeladeraEntreFechas(Heladera heladera, LocalDate fechaInicio, LocalDate fechaFin){
        return this.aperturasEntreFechas(fechaInicio,fechaFin).stream().filter(apertura -> apertura.getMotivo() == INGRESAR_VIANDAS_DONADAS).toList().size();
    }
    public Integer cantidadDeRetirosDeHeladeraEntreFechas(Heladera heladera, LocalDate fechaInicio, LocalDate fechaFin){
        return this.aperturasEntreFechas(fechaInicio,fechaFin).stream().filter(apertura -> apertura.getMotivo() == RETIRAR_VIANDA).toList().size();
    }
    ...
    public void agregarApertura(Apertura apertura) {
        ...
        System.out.println("Agregue apertura " + apertura.getMotivo() + " " + apertura.getFecha());
    }
